...
*** Treemacs
Enable follow-mode so the treemacs cursor follows the buffer file. Also increase the default width to show more stuff. And disable locked width.
...
Turn on [[https://github.com/emacs-lsp/lsp-mode/wiki/Debugging][LSP Debugging]].
